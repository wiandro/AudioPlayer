package com.wiandro.audioplayer.notification
...
import com.wiandro.audioplayer.R
import com.wiandro.audioplayer.exo.PlaybackState
import com.wiandro.audioplayer.model.ASong
import com.wiandro.audioplayer.service.SongPlayerService
import java.io.File
...
constructor(private val mService: SongPlayerService) : BroadcastReceiver() {
    ...
    private fun createContentIntent(): PendingIntent {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("musicplayer://")).apply {
